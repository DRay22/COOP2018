...
#   Require an input to run the calculation (There are no inputs required, so I just make it so that you press enter)
#   Run Calculation using formula to calculate both fahrenheit and celsius in intervals of ten:
#   Formula:                     fahrenheit0 = (9 / 5) * 0 + 32
#
...
#
#   Print Output for each variable so that they are side by side
#   Output:                     print("Here are your temperatures")
...
def main():
    ...
    # Require an input to run the calculation
