...
from Chapter07.U07_Ex03_CSGrading import *
from Chapter07.U07_Ex05_BMIIndex import *
from Chapter07.U07_Ex11_LeapYear import *
from Chapter07.U07_Ex12_ValidDate import *
...
def testLeap():
    ...
    #               should be correct data type)
    # copy line multiple times to run multiple tests (with different parameters)
    results.append(runTest('LeapTest(1600)', "The year {0}, is a leap year".format(1600)))
    results.append(runTest('LeapTest(2000)', "The year {0}, is a leap year".format(2000)))
    results.append(runTest('LeapTest(2146)', "The year {0}, is not a leap year".format(2146)))
    results.append(runTest('LeapTest(2033)', "The year {0}, is not a leap year".format(2033)))
    printResults(results)
